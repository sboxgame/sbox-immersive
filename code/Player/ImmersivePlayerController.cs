...
public class ImmersivePlayerController : Component
{
	...
	protected override void OnUpdate()
	{
		...
		if ( camera is not null )
		{
			...
			if ( FirstPerson ) camPos = Eye.Transform.Position + EyeAngles.ToRotation().Forward * 8 + Vector3.Up * EyeDuckOffset;
	...
	protected override void OnFixedUpdate()
	{
		...
		EyeDuckOffset = EyeDuckOffset.LerpTo( Input.Down("duck") ? -32 : 0, Time.Delta * 10.0f );
